...
extension UIColor {
    ...
    enum Gradient {
        static func background() -> [UIColor] { [#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), #colorLiteral(red: 0.1244538462, green: 0.0396984442, blue: 0.2261537536, alpha: 1), #colorLiteral(red: 0.1718740504, green: 0.05295932093, blue: 0.2666872625, alpha: 1), #colorLiteral(red: 0.2293560037, green: 0.05485886774, blue: 0.2839770118, alpha: 1), #colorLiteral(red: 0.3199191, green: 0.08372647133, blue: 0.3746734773, alpha: 1), #colorLiteral(red: 0.4430136983, green: 0.1394162962, blue: 0.4683914955, alpha: 1)] }
        static func background1() -> [UIColor] { [#colorLiteral(red: 0.2605174184, green: 0.2605243921, blue: 0.260520637, alpha: 1), #colorLiteral(red: 0.2605174184, green: 0.2605243921, blue: 0.260520637, alpha: 1), #colorLiteral(red: 0.2371303211, green: 0.2046647439, blue: 0.2666872625, alpha: 1), #colorLiteral(red: 0.2400550281, green: 0.1592444586, blue: 0.2839770118, alpha: 1), #colorLiteral(red: 0.3199191, green: 0.08372647133, blue: 0.3746734773, alpha: 1), #colorLiteral(red: 0.4430136983, green: 0.1394162962, blue: 0.4683914955, alpha: 1)] }
        static func background2() -> [UIColor] { [#colorLiteral(red: 0.2605174184, green: 0.2605243921, blue: 0.260520637, alpha: 1), #colorLiteral(red: 0.2605174184, green: 0.2605243921, blue: 0.260520637, alpha: 1), #colorLiteral(red: 0.4430136983, green: 0.1394162962, blue: 0.4683914955, alpha: 1)] }
    }
    ...
    enum TVColor {
        ...
        static func navBarColor() -> UIColor { #colorLiteral(red: 0.2605174184, green: 0.2605243921, blue: 0.260520637, alpha: 1) }
    }
}
